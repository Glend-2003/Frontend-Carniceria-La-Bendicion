...
const TipoPagoApp = () => {
  ...
  const actualizarTipoPago = async () => {
    ...
    try {
      await axios.put("https://backend-carniceria-la-bendicion-qcvr.onrender.com/tipopago/actualizar", tipoPagoData);
  ...
  const activarDesactivarTipoPago = async (id) => {
    try {
      await axios.put(`https://backend-carniceria-la-bendicion-qcvr.onrender.com/tipopago/activar/${id}`);
